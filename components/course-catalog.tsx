...
export function CourseCatalog() {
  ...
  return (
    <section id="courses" className="mb-12 scroll-mt-28 lg:mb-14" ref={ref}>
      <motion.div
        className="home-panel mb-7 rounded-[2.1rem] px-5 py-6 sm:px-7"
      ...
      >
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm text-slate-600 dark:text-slate-300">
            Start from your area of interest. Choose a category below to jump into the
            complete course page with focused options for all levels.
          </p>
        </div>
      </motion.div>
